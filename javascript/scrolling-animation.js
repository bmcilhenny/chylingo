...
$(document).ready(function() {
	...
	//$('.beginningText').delay(3000).textFade();
});

/*$win.on('scroll', function() {
	var top = $win.scrollTop();
	$trump.css('transform', 'rotate('+ top +'deg)');
}); */
//when trump's right positioning is equal to - 200 I want to trigger the slideInRight animation on $startLessonButton
